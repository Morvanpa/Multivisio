...
YOLO_MODEL = '/home/shakib/Desktop/S4/multivision/result/20_epochsf2/weights/best.pt'
DEEP_SORT_WEIGHTS = '/home/shakib/Desktop/S4/multivision/Tracking-and-counting-Using-YOLOv8-and-DeepSORT/deep_sort/deep/checkpoint/ckpt.t7'
...
def main(video_path, output_path):
    ...
    while cap.isOpened():
        ...
        results = model(frame, device=device, classes=[0, 28], conf=0.5)
        ...
        if len(detections) > 0:
            ...
            for track in tracks:
                if track[4] != -1:  # Vérification si le track est valide
                    ...
                    color = (0, 255, 0) if len(detections) > 0 and detections[0][2] == 0 else (0, 0, 255)
                    label = f"ID {track_id}"
                    ...
                    # Enregistrer les IDs uniques
                    unique_track_ids.add(track_id)
        else:
            print("Aucune détection pour ce frame.")

        # Affichage du nombre total de personnes/valises suivies
        ...
        cv2.putText(og_frame, f"FPS: {fps_counter:.2f}", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
...
if __name__ == "__main__":
    VIDEO_PATH = '/home/shakib/Desktop/S4/multivision/deepsort/airport.mp4'  # Chemin vers la vidéo d'entrée
    OUTPUT_PATH = '/home/shakib/Desktop/S4/multivision/deepsort/airportsort.mp4' # Chemin de sortie
...
if __name__ == "__main__":
    VIDEO_PATH = '/home/shakib/Desktop/S4/multivision/Tracking-and-counting-Using-YOLOv8-and-DeepSORT/w1.mp4'  # Chemin vers la vidéo d'entrée
    OUTPUT_PATH = '/home/shakib/Desktop/S4/multivision/deepsort/airportsort.mp4' # Chemin de sortie
    main(VIDEO_PATH, OUTPUT_PATH)
...
def main(video_path, output_path, skip_frames=5):
    # Initialisation de la vidéo
    cap = cv2.VideoCapture(video_path)
    if not cap.isOpened():
        print("Erreur : Impossible d'ouvrir la vidéo.")
